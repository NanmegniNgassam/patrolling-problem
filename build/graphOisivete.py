...
if __name__ == '__main__':
    ...
    chemins = []
    chemins.append((0, 2, 5, 32, 34, 35, 33, 35, 19, 14, 16, 18, 17, 20, 15, 20, 38, 36, 37, 39, 37, 36, 38, 20, 15, 20, 17, 18, 16, 14, 19, 35, 33, 35, 34, 32, 5, 2, 0))
    chemins.append((0, 4, 3, 44, 46, 48, 45, 49, 47, 49, 21, 27, 23, 25, 24, 22, 26, 42, 26, 22, 24, 25, 23, 27, 21, 49, 47, 49, 45, 48, 46, 44, 3, 4, 0))
    chemins.append((0, 1, 6, 28, 30, 31, 29, 13, 7, 9, 11, 8, 10, 12, 41, 43, 41, 40, 41, 43, 41, 12, 10, 8, 11, 9, 7, 13, 29, 31, 30, 28, 6, 1, 0))
