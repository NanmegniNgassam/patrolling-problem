...
def agent_process(agent_id, position_queue, last_visited_shared):
...
if __name__ == '__main__':
    ...
    for i in range(num_agents):
        ...
        agent = multiprocessing.Process(target=agent_process, args=(i, position_queue, last_visited_shared))
        agents.append(agent)
        agent.start()
