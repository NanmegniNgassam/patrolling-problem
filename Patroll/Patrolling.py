...
if __name__ == '__main__':
    ...
    for i in range(num_agents):
        ...
        if algorithm == "Random":
            agent = multiprocessing.Process(target=agent_process_astar, args=(i, position_queue, last_visited_shared, shared_list_next_node, lock,stop_simulation))
        elif algorithm == "Runtime":
            agent = multiprocessing.Process(target=agent_process, args=(i, num_agents,position_queue, last_visited_shared, shared_list_next_node, lock,agent_positions,shared_list_chemins,node_locked,stop_simulation))
